...
- Web：本地开发、Vercel、Deno、Cloudflare Workers
- Desktop：Windows 上可用 `Tauri 2` 构建本地可执行文件
...
AnyPeek 把这件事尽量变简单了：打开网页，贴上 URL，或者直接拖进文件，就能查看。
...
- [部署指南](./docs/DEPLOYMENT.md)：本地、Vercel、Deno、Cloudflare Workers、Tauri 五种方案
